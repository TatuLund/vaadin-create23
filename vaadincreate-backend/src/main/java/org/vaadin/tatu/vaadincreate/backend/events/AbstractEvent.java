...
public sealed interface AbstractEvent permits LockingEvent, MessageEvent, BooksChangedEvent, CategoriesUpdatedEvent, UserUpdatedEvent, ShutdownEvent {
    // This interface serves as a marker for all event types in the system.
    // It can be extended with common methods or properties if needed in the future.
}
