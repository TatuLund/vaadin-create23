 ...
 * 
 * <p>
 * The lifecycle of a purchase typically progresses as follows:
 * <ul>
 ...
 * <li>{@link #CANCELLED} - Purchase cancelled due to insufficient
 * inventory</li>
 * </ul>
 */
public enum PurchaseStatus {
    ...
    /**
     * Purchase has been approved and stock has been decremented. This is the
     * final successful state.
     */
    COMPLETED,

    /**
     * Purchase was explicitly rejected by the supervisor. No stock changes
     * occurred.
     */
    REJECTED,

    /**
     * Purchase was cancelled because items were missing in inventory at the
     * time of approval.
     */
    CANCELLED
}
