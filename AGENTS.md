...
This file is the authoritative repository-specific instruction source for AI coding agents in this workspace.

Use `.copilot-instructions.md` as a thin compatibility entrypoint for tools that prefer that filename. Keep repo-specific guidance here to avoid drift.
