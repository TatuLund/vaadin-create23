...
- Use SASS for styling according to Vaadin conventions
- Place CSS class name constants in VaadinCreateTheme class
- Use SASS mixins for each view
- Place responsive styles in responsive.scss mixin
- Use BEM naming convention for CSS classes
- Use Vaadin responsive features for mobile optimization

## Code formatting
- Run `mvn spotless:apply` to format code according to the project's code style
- Do not disable or bypass code formatting checks in CI
